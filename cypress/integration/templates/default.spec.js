...
describe("Template: default", () => {
  ...
  it("should renders module name correctly", () => {
    ...
    cy.get('nav a[href="module-better-components_BetterCounter.html"]').contains("better-components/BetterCounter")
  })
...
describe("Template JS: default", () => {
  ...
  it("should renders module name correctly", () => {
    ...
    cy.get('nav a[href="module-CounterJS.html"]').contains("CounterJS")
  })
