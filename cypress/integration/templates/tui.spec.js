...
describe("Template: tui", () => {
  ...
  it("should renders module name correctly", () => {
    cy.get(".title").contains("Module: better-components/BetterCounter")

    cy.get("h2").contains("better-components/BetterCounter")

    cy.get('nav.lnb .lnb-api li a[href="module-better-components_BetterCounter.html"]').contains(
  ...
  it("should renders computed correctly", () => {
    const computeds = [
      {
        name: "<code>fooList</code>",
        type: '<span class="param-type">Array.&lt;String&gt;</span>',
        description: "A list of foo",
      },
      {
        name: "<code>barList</code>",
        type: '<span class="param-type">Array.&lt;String&gt;</span>',
        description: "A list of bar",
      },
    ...
    const events = [
      {
        ...
        type: '<span class="param-type">Number</span>',
        description: "Emit counter's value after increment",
      },
      {
        name: "<code>decrement</code>",
        type: '<span class="param-type">Number</span>',
        description: "Emit counter's value after decrement",
      },
    ]
...
describe("Template JS: tui", () => {
  ...
  it("should renders module name correctly", () => {
    cy.get(".title").contains("Module: CounterJS")

    cy.get("h2").contains("CounterJS")

    cy.get('nav.lnb .lnb-api li a[href="module-CounterJS.html"]').contains("CounterJS")
  })
  ...
  it("should render methods properly", () => {
    cy.contains("h3", "Methods").should("have.attr", "class", "subsection-title")
    cy.get("#decrement").contains("decrement()").contains('a[href="js_CounterJS.js.html#line43"]', "line 43")

    cy.get("#increment").contains("increment()").contains('a[href="js_CounterJS.js.html#line36"]', "line 36")

    cy.get("#showDialog").contains("showDialog(counter)").contains('a[href="js_CounterJS.js.html#line51"]', "line 51")
